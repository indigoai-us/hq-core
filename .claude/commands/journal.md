---
description: Write a session-level journal entry to workspace/threads/journal/<today>/. Helps autocompact discard raw tool-results by leaving structured working memory behind.
allowed-tools: Bash, Read, Write
argument-hint: "<title> | --list | --read <NNN>"
visibility: public
---
