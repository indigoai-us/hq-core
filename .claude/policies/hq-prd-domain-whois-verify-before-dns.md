...
- `.claude/policies/hq-pre-deploy-domain-check.md` — deploy-registry lookup for owned projects (assumes ownership is established)
- `.claude/policies/hq-cmd-run-project-preflight-pause-stale-state.md` — generic preflight pause

## Related

- `.claude/policies/hq-pre-deploy-domain-check.md`
- `.claude/policies/hq-cmd-run-project-preflight-pause-stale-state.md`
