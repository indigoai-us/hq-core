...
The publisher had built from a stale local branch; the artifact carried none of the split's changes. Downstream users installing the package got the old behavior while the PRD claimed the stories were complete.
