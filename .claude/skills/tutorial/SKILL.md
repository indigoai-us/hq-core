...
- **HQ refs:** `.claude/skills/run-project/SKILL.md`, `core/settings/orchestrator.yaml`, `workspace/orchestrator/active-runs.json`
...
- **Show:**
  - Read `.claude/skills/run-project/SKILL.md` — walk through the orchestrator's task-selection loop
