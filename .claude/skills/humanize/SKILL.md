...
This skill is the enforcement vehicle for the hard policy `humanize-generated-content`. Whenever you generate or revise a human-facing prose deliverable, run this pass before delivering it.
...
3. **When no sample is provided,** fall back to the default behavior (natural, varied, opinionated voice from the PERSONALITY AND SOUL section below). For HQ, the owner's default voice reference is `personal/agents-profile.md` — read it when humanizing the owner's first-person content.
...
This skill is based on [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, and ported from [blader/humanizer](https://github.com/blader/humanizer) v2.7.0 (MIT). The patterns documented there come from observations of thousands of instances of AI-generated text on Wikipedia.
