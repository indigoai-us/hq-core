...
**On no-identity path** (Phase A returned `login_required`): preview URL was already emitted in Phase B; emit upsell once if `/tmp/hq-deploy-upsold-$USER` doesn't exist:
