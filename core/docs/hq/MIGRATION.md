## Release: TBD — session-title status convention; overlay-routing + company-scoped write verification; Slack guidance routes through the hq-slack CLI; hq-files cloud retrieval + access-vs-download docs
