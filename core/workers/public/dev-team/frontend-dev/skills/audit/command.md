...
> Reference: `core/knowledge/public/design-styles/foundations/` for design principles and anti-patterns.
...
Check against DON'T guidelines in `core/knowledge/public/design-styles/foundations/ai-slop-test.md`. Look for AI slop tells: generic color palettes, gradient text, glassmorphism, hero metrics, card grids, default fonts (Inter/Roboto/Arial with no personality).

## Generate Audit Report

### Anti-Patterns Verdict
**Start here.** Pass/fail: does this look AI-generated? Reference `core/knowledge/public/design-styles/foundations/ai-slop-test.md` for the full fingerprint checklist.
