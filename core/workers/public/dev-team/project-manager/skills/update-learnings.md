...
3. Route to appropriate location:
   ...
   - Pattern → `core/knowledge/public/dev-team/patterns/{category}/`
   - Troubleshooting → `core/knowledge/public/dev-team/troubleshooting/`
   - Workflow → `core/knowledge/public/dev-team/workflows/`
...
| pattern | core/knowledge/public/dev-team/patterns/ | "Retry pattern for flaky external APIs" |
| troubleshoot | core/knowledge/public/dev-team/troubleshooting/ | "ESLint fails on CI but not local" |
| workflow | core/knowledge/public/dev-team/workflows/ | "For DB-heavy: database-dev before architect" |
...
# Output:
# Routing learnings:
# - [pattern] → core/knowledge/public/dev-team/patterns/backend/jwt-session-tokens.md
# - [troubleshoot] → core/knowledge/public/dev-team/troubleshooting/redis-auth-order.md
#
