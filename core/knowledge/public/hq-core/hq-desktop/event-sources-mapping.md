...
| File Path | Change Type | Frequency | Payload |
|-----------|-------------|-----------|---------|
| `core/workers/registry.yaml` | Modify | Rare (~1-3/month, new workers added) | Full registry YAML |
| `core/workers/*/worker.yaml` | Modify | Low (~1-5/week, learnings injected) | Updated worker config |
...
- Company detail refresh (core/settings/data changes)
...
| File Path | Change Type | Frequency | Payload |
|-----------|-------------|-----------|---------|
| `core/knowledge/public/**/*.md` | Create/Modify | ~2-10/day | Markdown content |
| `core/knowledge/private/**/*.md` | Create/Modify | ~1-5/day | Markdown content |
| `core/knowledge/public/*/INDEX.md` | Modify | ~1-5/day (reindex) | Directory map |
...
| `workers-watcher` | `core/workers/` | Yes | 1000ms | registry-changed, worker-updated |
| `companies-watcher` | `companies/` | No (depth 2) | 1000ms | company-changed, manifest-changed |
| `knowledge-watcher` | `core/knowledge/` | Yes | 2000ms | knowledge-changed |
...
4. **Directory-level events**: For core/knowledge/, emit directory-level change events rather than per-file (too noisy)
