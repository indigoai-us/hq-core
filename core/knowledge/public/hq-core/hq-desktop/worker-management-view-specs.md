...
│ ┌─ Context Files ─────────────────────────────────────────────────┐ │
│ │  Base:                                                           │ │
│ │    core/workers/public/dev-team/frontend-dev/                          │ │
│ │    core/knowledge/public/design-styles/                                │ │
│ │  Dynamic:                                                        │ │
...
│ │    Injected to: core/workers/public/dev-team/architect/worker.yaml    │ │
│ │                                                                  │ │
...
│                                                                     │
│ ┌─ Context Loaded ────────────────────────────────────────────────┐ │
│ │  core/workers/public/dev-team/frontend-dev/worker.yaml                │ │
│ │  core/workers/public/dev-team/frontend-dev/skills/generate-code.md    │ │
│ │  core/knowledge/public/design-styles/glass-morphism.md                │ │
│ └─────────────────────────────────────────────────────────────────┘ │
│                                                                     │
...
│ │  │ → core/workers/public/dev-team/architect/worker.yaml           │   │ │
│ │  │ Task: US-007 (hq-desktop-epics)                           │   │ │
│ │  └──────────────────────────────────────────────────────────┘   │ │
│ │                                                                  │ │
│ │  ┌──────────────────────────────────────────────────────────┐   │ │
...
|------|--------------------|--------|
| Workers Drill (no workers) | "No workers found. Workers are defined in core/workers/registry.yaml." | Link to docs |
