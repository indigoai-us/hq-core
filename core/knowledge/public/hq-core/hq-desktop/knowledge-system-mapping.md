...
### Tier 1: HQ-Level Knowledge (`core/knowledge/`)
...
|----------|--------|---------|
| `core/knowledge/public/INDEX.md` | Yes | Lists all public knowledge bases |
...
3. **HQ-level knowledge is universal**: `core/knowledge/public/*` and `core/knowledge/private/*` are accessible regardless of active company context. These contain framework docs (Ralph, workers, dev-team) that apply everywhere.
