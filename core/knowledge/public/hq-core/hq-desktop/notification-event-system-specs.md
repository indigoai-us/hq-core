...
| `workers` | `core/workers/` | Yes | 1000ms | `registry.yaml`, `worker.yaml` | `hq://registry-changed`, `hq://worker-updated` |
| `companies` | `companies/` | Depth 2 | 1000ms | `manifest.yaml`, any | `hq://manifest-changed`, `hq://company-changed` |
| `knowledge` | `core/knowledge/` | Yes | 2000ms | `*.md` | `hq://knowledge-changed` |
...
[18:05:03.100] workers      worker-updated     core/workers/public/dev-team/architect/worker.yaml
```
