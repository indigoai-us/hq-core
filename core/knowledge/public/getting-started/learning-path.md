...
| Resource | Location |
|----------|----------|
| Quick Start Guide | `core/knowledge/getting-started/quick-start-guide.md` |
| Daily Cheatsheet | `core/knowledge/getting-started/cheatsheet.md` |
| Ralph Methodology | `core/knowledge/Ralph/` |
| Worker Registry | `core/workers/registry.yaml` |
