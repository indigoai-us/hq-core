...
- **Daily reference** — keep `core/knowledge/getting-started/cheatsheet.md` handy
- **Learning path** — see `core/knowledge/getting-started/learning-path.md` for the full 11-module progression
