...
#
# Usage:
#   core/scripts/audit-log.sh append --event task_started --project my-project [fields...]
#   core/scripts/audit-log.sh query [--project X] [--company X] [--worker X] [--since X] [--event X]
#   core/scripts/audit-log.sh summary
#
...
#     [--files "core/scripts/audit-log.sh,workspace/metrics/audit-log.jsonl"] \
#     [--result success] \
#     [--duration-ms 1234] \
#     [--error "message"] \
#     [--session-id abc123]
...
EXAMPLES:
  ...
  core/scripts/audit-log.sh query --project hq-observability --event task_failed

  # Query since a date
  core/scripts/audit-log.sh query --since 2026-03-01
