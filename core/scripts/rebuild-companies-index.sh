...
#
# It ships at assets/scaffold/core/scripts/rebuild-companies-index.sh inside @indigoai-us/hq-cli and
# runs as the hidden command `hq core rebuild-index companies`. This file stays behind so every
...
exec hq core --hq-root "$HQ_ROOT" rebuild-index companies "$@"
