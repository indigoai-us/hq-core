...
#
# Usage:
#   core/scripts/archive-old-threads.sh              # run archive, 60-day cutoff
#   core/scripts/archive-old-threads.sh --days 90    # custom cutoff
#   core/scripts/archive-old-threads.sh --gated      # skip if ran within 24h
#   core/scripts/archive-old-threads.sh --dry-run    # preview without moving
