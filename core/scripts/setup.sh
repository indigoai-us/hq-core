...
echo ""
echo "  Next steps:"
echo "    1. Follow the guided HQ tutorial (videos + written steps):"
echo "       https://www.hqforwork.com/getting-started/tutorials/install-hq-macos?source=hq_setup_script"
