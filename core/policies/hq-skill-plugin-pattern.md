...
2. Create `core/scripts/{package}-bridge.sh` — iterate dirs with SKILL.md, symlink each to
...
ALWAYS skip infrastructure dirs (bin/, core/scripts/, test/) via a skip list.
