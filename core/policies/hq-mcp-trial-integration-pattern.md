...
Launcher, README, baseline metrics, and any support scripts all live under `workspace/reports/{trial-name}/` — NOT under `.claude/hooks/` or `core/scripts/` (both protect-core locked; a trial is not HQ infrastructure).
