...
#
# Usage:
#   scripts/hq-session.sh current               # print current session_id (or empty)
#   scripts/hq-session.sh path                  # print path to current meta.yaml
#   scripts/hq-session.sh get <key>             # read a key from meta.yaml
#   scripts/hq-session.sh set <key> <value>     # set/replace a top-level key
#
